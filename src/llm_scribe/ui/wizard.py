...
class FirstRunWizard(ctk.CTkToplevel):
    ...
    def setup_ui(self):
        ...
        self.title_label = ctk.CTkLabel(self.content_frame, text="", font=self.fonts["title"])
        self.title_label.pack(pady=(0, 20))

        self.desc_label = ctk.CTkLabel(self.content_frame, text="", font=self.fonts["main"], wraplength=400, justify="left")
        ...
        self.prev_btn = ctk.CTkButton(self.nav_frame, text="上一步 (Prev)", width=100, command=self.prev_step)
        self.prev_btn.pack(side=ctk.LEFT, padx=20)

        self.next_btn = ctk.CTkButton(self.nav_frame, text="下一步 (Next)", width=100, command=self.next_step)
